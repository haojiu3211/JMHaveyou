...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/NEChatKit/NOS/NEChatKit.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/NEChatUIKit/NOS/NEChatUIKit.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/NECommonKit/NECommonKit.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/NECommonUIKit/NECommonUIKit.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/NECoreIM2Kit/NOS/NECoreIM2Kit.framework"
