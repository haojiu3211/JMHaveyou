...
variant_for_slice()
{
  ...
  "NTESQuickPass.xcframework/ios-arm64")
    echo ""
    ;;
  "NTESQuickPass.xcframework/ios-arm64_x86_64-simulator")
    echo "simulator"
    ;;
...
install_xcframework "${PODS_ROOT}/NTESQuickPass/Classes/NTESQuickPass.xcframework" "NTESQuickPass" "framework" "ios-arm64" "ios-arm64_x86_64-simulator"
...
install_xcframework "${PODS_ROOT}/NTESQuickPass/Classes/OAuth.xcframework" "NTESQuickPass" "framework" "ios-arm64" "ios-arm64_x86_64-simulator"
